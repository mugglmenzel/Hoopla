 ...
 *         /aotearoa/de.eorganization.hoopla.shared.model/model/ahp/values/AlternativeValuesMatrix.java $
 * 
 * 
 */
...
public class AlternativeValuesMatrix implements Serializable {
	...
	private void setMatrixWeights() {
		...
		for (AlternativeValue value : values) {
			vals.set(value.getAlt(), value.getValue() == 0
					|| value.getValue() == null ? 1D : value.getValue());
		}
