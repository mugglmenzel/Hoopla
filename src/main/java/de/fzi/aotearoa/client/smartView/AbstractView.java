...
public abstract class AbstractView implements IView {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.fzi.aotearoa.client.smartView.IView#getLayout()
	 */
	 ...
	 * 
	 * @see
	 * de.fzi.aotearoa.client.smartView.IView#setHeading(com.smartgwt.client
	 * .widgets.Label)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.fzi.aotearoa.client.smartView.IView#getHeading()
	 */
	 ...
	 * 
	 * @see
	 * de.fzi.aotearoa.client.smartView.IView#setInstructions(com.smartgwt.client
	 * .widgets.Label)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.fzi.aotearoa.client.smartView.IView#getInstructions()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.fzi.aotearoa.client.smartView.IView#getNavigation()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.fzi.aotearoa.client.smartView.IView#getContent()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.fzi.aotearoa.client.smartView.IView#getPostit()
	 */
	 ...
	 * 
	 * @see
	 * de.fzi.aotearoa.client.smartView.IView#setPostitHeader(com.smartgwt.client
	 * .widgets.Label)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.fzi.aotearoa.client.smartView.IView#getPostitHeader()
	 */
	...
	public void nextTab(final int nextNo) {
		AotearoaSmart.tabs.selectTab(nextNo != -1 ? nextNo : AotearoaSmart.tabs
				.getSelectedTabNumber() + 1);
		AotearoaSmart.tabs.getSelectedTab().fireEvent(
				new TabSelectedEvent(null));
	}

	public void previousTab(final int prevNo) {
		AotearoaSmart.tabs.selectTab(prevNo != -1 ? prevNo : AotearoaSmart.tabs
				.getSelectedTabNumber() - 1);
		AotearoaSmart.tabs.getSelectedTab().fireEvent(
				new TabSelectedEvent(null));
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.fzi.aotearoa.client.smartView.IView#goNext()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.fzi.aotearoa.client.smartView.IView#asTemplateAndGoNext()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.fzi.aotearoa.client.smartView.IView#goBack()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.fzi.aotearoa.client.smartView.IView#update()
	 */
