...
import de.fzi.aotearoa.client.smartView.canvas.AlternativeDetailsWindow;
import de.fzi.aotearoa.client.smartView.canvas.AlternativesListGrid;
 ...
 *         
 *         SVN URL: 
 *         $HeadURL: https://aotearoadecisions.googlecode.com/svn/trunk/src/main/java/de/fzi/aotearoa/client/smartView/AlternativesView.java $
 *
 */
...
public class AlternativesView extends AbstractView {
	...
	public AlternativesView() {
		...
		getPostit()
				.setContents(
						"The list on the left shows alternative solutions to implement your project. Every solution can be a Cloud or a non-Cloud option. Add all possible options to the list to let Aotearoa help you with finding out which is the preferred option according to your goals and preferences.");
	...
	public void asTemplate() {
		AotearoaSmart.aotearoaService.storeDecisionTemplate(new DecisionTemplate(AotearoaSmart.decision), new AsyncCallback<DecisionTemplate>() {
